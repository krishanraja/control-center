    ...
    <div className="flex items-center gap-1.5 mt-3 flex-wrap flex-shrink-0">
      {present.map(l => (
        <a
          ...
          className="flex items-center gap-1 px-2.5 py-1 rounded-md text-micro font-medium border border-white/10 text-ink-muted hover:bg-white/[0.06] active:bg-white/[0.1] transition-colors"
        >

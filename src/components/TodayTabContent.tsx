      ...
      <div className="space-y-6">
        ...
        <section>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-[11px] font-bold uppercase tracking-widest text-slate-400">Job Applications</h2>
          </div>
          <a
            href="https://docs.google.com/spreadsheets/d/1gJHU37h8nSw8K2XA6fphpC1UiAukR_BTJ9e39os5oh8/edit"
            target="_blank"
          ...
          >
            <div>
              ...
              <p className="text-[11px] text-white/35 mt-0.5">Applications, CVs, cover letters</p>
            </div>

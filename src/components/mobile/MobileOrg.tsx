        ...
        actions={
          open
            ? [
                ...
                // Editing an agent brief is careful writing, which is desktop
                // work by contract (mobile finishes decisions, never starts
                // composition). The old window.prompt() textarea-on-a-phone is
                // gone; the sheet reads the brief, the desktop Org tab edits it.
              ]
            : []
        }
      />

...
export function TeamStrip({ agents, onSelect, title = 'Team' }: Props) {
  ...
  return (
    <div className="space-y-2">
      <p className="text-micro font-bold uppercase tracking-[0.14em] text-ink-faint px-1">
        {title} · {agents.length}
      </p>
        ...
        {agents.map(a => {
          ...
          return (
            ...
            >
              ...
              <span className="text-micro text-ink-muted font-medium truncate max-w-[60px]">
                {a.humanName}
              </span>
            </button>
          )

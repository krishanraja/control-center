...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('text-ui font-semibold leading-tight text-ink', className)}
      {...props}
    />
  )
}
...
function CardDescription({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div data-slot="card-description" className={cn('font-body text-label leading-relaxed text-ink-muted', className)} {...props} />
  )
}

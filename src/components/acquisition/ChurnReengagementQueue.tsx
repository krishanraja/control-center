  ...
  return (
    <section className="rounded-xl border border-white/[0.07] bg-white/[0.015] overflow-hidden">
      <header className="px-4 py-3 flex items-center gap-2 border-b border-white/[0.06]">
        ...
        <span className="ml-auto text-micro text-ink-faint tabular-nums">{rows.length}</span>
      </header>
            ...
            <div key={l.id} className="px-4 py-2.5">
              ...
              {l.email && (
                <button
                  ...
                  className="mt-1.5 rounded-lg border border-white/[0.1] px-2.5 py-1 text-micro font-medium text-ink-faint hover:text-ink hover:border-white/25 transition-colors disabled:opacity-40"
                >

      ...
      {detail.paused && (
        <div className="px-4 py-2.5 border-b border-white/[0.04] bg-rose-500/[0.06] flex items-center gap-2">
          ...
          <button
            ...
            className="rounded-lg border border-emerald-400/30 bg-emerald-500/10 px-2.5 py-1 text-micro font-medium text-emerald-300 hover:bg-emerald-500/20 transition-colors disabled:opacity-40 flex items-center gap-1"
          >
            <Play size={10} /> Resume
          </button>
        </div>
            ...
            <div className="space-y-1.5">
              <div>
                <div className="flex items-baseline justify-between mb-0.5">
                  <span className="text-micro text-emerald-300/80">Attributed MRR</span>
                  <span className="text-micro tabular-nums text-emerald-300">${Number(econ.attributed_mrr).toFixed(2)}</span>
                </div>
        ...
        {editing && (
          <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-3 space-y-2">
            ...
            <button
              ...
              className="rounded-lg bg-violet-500/15 border border-violet-400/30 px-3 py-1 text-micro font-medium text-violet-300 hover:bg-violet-500/25 transition-colors disabled:opacity-40"
            >
              Save budget
            </button>
          </div>

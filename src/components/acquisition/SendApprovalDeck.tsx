...
export function SendApprovalDeck({
  ...
  return (
    <section className="rounded-xl border border-white/[0.07] bg-white/[0.015] overflow-hidden">
      ...
      {autonomyLevel === 'L2' && (
        <div className="px-4 py-2 text-micro text-cyan-300/80 border-b border-white/[0.04] bg-cyan-400/[0.04]">
          L2 lane — these are the 1-in-10 samples. Unsampled sends go out automatically.
        </div>
      )}
      {autonomyLevel === 'L3' && sends.length === 0 && (
        <div className="px-4 py-2 text-micro text-emerald-300/80 border-b border-white/[0.04] bg-emerald-400/[0.04]">
                    ...
                    <div className="mt-2 ml-6 space-y-2">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="rounded-lg bg-emerald-500/15 border border-emerald-400/30 px-3 py-1 text-micro font-medium text-emerald-300 hover:bg-emerald-500/25 transition-colors disabled:opacity-40"
                        >
                          Approve & send
                        </button>
                        <button
                          ...
                          className="rounded-lg bg-rose-500/10 border border-rose-400/25 px-3 py-1 text-micro font-medium text-rose-300 hover:bg-rose-500/20 transition-colors disabled:opacity-40"
                        >
                          Reject
                        </button>
                      </div>

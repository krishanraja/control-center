...
export const WORK = {
  ...
  'content.score':       { agent: 'cleo', doing: 'scoring the five standards', sub: 'Reading it the way a reader would', expectedMs: 35_000 },
  ...
  'content.channelCut':  { agent: 'cleo', doing: 'cutting it for the channel', expectedMs: 30_000 },
  'content.synthesize':  { agent: 'cleo', doing: 'drafting one narrative from these cards', expectedMs: 40_000 },
  'content.cluster':     { agent: 'cleo', doing: 'clustering the pile' },
  ...
  'focus.slate':         { agent: 'marcus', doing: 'assembling the slate', sub: 'Reading the week against your goals', expectedMs: 30_000 },

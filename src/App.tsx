...
type TabId = 'home' | 'today' | 'plans' | 'leads' | 'customers' | 'org' | 'exec' | 'workflows' | 'systems'
const VALID_TABS: TabId[] = ['home', 'today', 'plans', 'leads', 'customers', 'org', 'exec', 'workflows', 'systems']

...
export function buildGeoSystem(ctx: GeoContext): string {
  ...
  return [
    ...
    '',
    'THE REGISTER: A MANIFESTO, NOT AN EXPLAINER',
    'This is a page a real person lands on, and dry and correct loses to sharp and correct every time. Write it as a position taken, not a topic surveyed.',
    'Open on what is actually at stake for the reader, in the first line, before any setup. Take a side early and stay on it. Short sentences. Real verbs. A rhythm someone reads to the end rather than skims.',
    'Say the thing most people in this market will not say. A page that could have been written by any of the sites currently answering is a page nobody has a reason to quote, and an argument nobody disagrees with is not an argument.',
    'Name the received wisdom you are rejecting and reject it plainly. That is what makes it thought leadership rather than content.',
    'Earn every claim. Manifesto energy without evidence is just noise, and the evidence is the part the other sites cannot copy.',
    'End on a verdict that points forward. Never a summary, never a rhetorical question, never a call to action.',
    'What this is not: a definition, a listicle, a balanced overview, a beginner guide, or a neutral explainer that hedges to stay safe.',
    '',

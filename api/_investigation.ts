// _investigation: the Techonomic weekly investigation: anchor selection, claim
...
export function buildManifest(m: ManifestInput): string {
  ...
  return [
    '## VERIFIED EVIDENCE MANIFEST (Techonomic investigation)',
    '',
...
async function attachMaterials(ideaId: string, runId: string, manifest: string): Promise<void> {
  ...
  filtered.push({
    ...
    kind: 'research',
    title: 'Techonomic investigation: verified evidence manifest',
    content: manifest,

...
const CASES: Case[] = [
  ...
  },
  {
    ...
    horizon: 'weekly', parentId: 'goal:mid:x',
    expectFail: ['fits_a_week'],
  },
  {
    what: 'a mid-term goal with no number is caught',
    title: 'Grow revenue meaningfully by end of Q4',
    horizon: 'mid_term', parentId: 'goal:os:x',
    expectFail: ['has_number'],
  },
  {
    what: 'a mid-term goal with no date is caught',
    title: 'Reach 200 paying customers',
    horizon: 'mid_term', parentId: 'goal:os:x',
    expectFail: ['has_date'],
  },
  {
    what: 'a well-formed mid-term goal passes the lint',
    title: 'Reach $20k MRR by 2026-12-31',
    horizon: 'mid_term', parentId: 'goal:os:x',
    expectPass: ['has_number', 'has_date', 'has_parent', 'single_goal'],
  },
  {
    what: 'an orphaned non-OS goal is caught',
    title: 'Reach $20k MRR by 2026-12-31',
    horizon: 'mid_term', parentId: null,
    expectFail: ['has_parent'],
  },
  {
    what: 'a venture objective must name its venture',
    title: 'Reach 100 CTRL activations by 2026-10-01',
    horizon: 'venture_objective', parentId: 'goal:mid:x', venture: null,
    expectFail: ['has_venture'],
  },
  {

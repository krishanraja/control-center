...
All three were hit for real on 2026-08-24. Read them before you push a
workflow file.
...
**2. `typeVersion` is per node type, not global.**
...
**3. `executeOnce: true` truncates a node's input to the first item.**

...
| `api/architecture/weekly.ts` | `/api/architecture/weekly` (cron, Sun 13:00 UTC): writes the week's builds into `docs/MINDMAKE_OS_ARCHITECTURE.md` section 20 on GitHub main; `?dry=1` | GET / POST |
